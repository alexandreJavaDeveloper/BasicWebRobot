...
public class RobotRules
{
    ...
    {
        final int firstValue = Integer.valueOf(responseSplitted[0]).intValue();
        final int secondValue = Integer.valueOf(responseSplitted[2]).intValue();
        final int thirdValue = Integer.valueOf(responseSplitted[4]).intValue();
        final int fourthValue = Integer.valueOf(responseSplitted[6]).intValue();
